          ...
          <div className="w-1/2 flex flex-col justify-between">
            <div>
              <p className="text-lg mb-4">
                Please take a <span className="font-bold">clear</span> and
                well-lit picture of the drug packaging where the{" "}
                <span className="font-bold">batch number</span> is printed.
              </p>

              <p className="text-lg mb-4">
                Make sure the entire batch number is{" "}
                <span className="font-bold">fully visible</span>
                and in focus, avoiding any glare or obstructions that could
                obscure the text.
              </p>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <Link href="/components/Camera">
                <button className="px-6 py-2 bg-slate-900 text-white rounded transition-colors">
                  {" "}
                  Take a picture{" "}
                </button>
              </Link>
